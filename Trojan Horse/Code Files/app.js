...
mongoose.connect("mongodb://localhost:27017/alumni_connects_v2", {
  useUnifiedTopology: true,
  useNewUrlParser: true
});

//create alumni db inside mongodb
...
app.post("/alumni/:id/email", function(req, res) {
  ...
  Alumni.findById(req.params.id, function(err, foundalumni) {
    if (err) {
      ...
      var string = 'multani2899@gmail.com' + ', ' + 'mehtabmultani51@gmail.com';
      var mailOptions = {
        from: 'multani2899@gmail.com',
...
app.post("/alumni", isLoggedIn, function(req, res) {
  ...
  request('https://maps.googleapis.com/maps/api/geocode/json?key=AIzaSyAPzLdcKEPCe4SQf3-cdSnq5vmh_MRaHCs' + '&address=' + encodeURIComponent(req.body.address),
