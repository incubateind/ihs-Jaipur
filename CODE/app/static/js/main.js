...
function calculateRouteFromAtoB(platform, origin, destination) {
    var router = platform.getRoutingService(),
        routeRequestParams = {
            ...
            routeattributes: 'waypoints,summary,shape,legs',
            maneuverattributes: 'direction,action',
            waypoint0: origin, // input field origin points
...
function onSuccess(result) {
    ...
    /*
     * The styling of the route response 
     */
...
function updatemap() {
    ...
    //add start and end marker to the map
    let ar1 = orign.split(',');
    let ar2 = destination.split(',');
    var pngIcon = new H.map.Icon("https://image.flaticon.com/icons/svg/252/252025.svg", { size: { w: 32, h: 32 } });
    //console.log(ar1); 
...
function addMarkersToMap(map) {
    var originmarker = new H.map.Marker({lat:26.8729,lng:75.6953});
    console.log('originmarker '+originmarker);
    var destinationmarker = new H.map.Marker({lat:26.8729,lng:75.6953});
    var dt = [originmarker, destinationmarker];
...
function showAccidents2(accident_json) {
    ...
    var markers = [];
    var pngIcon2 = new H.map.Icon("https://image.flaticon.com/icons/svg/252/252189.svg", { size: { w: 32, h: 32 } });
